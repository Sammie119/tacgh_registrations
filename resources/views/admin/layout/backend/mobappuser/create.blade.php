            ...
            <div class="row">
                <div class="box box-solid">
                    ...
                    <div class="panel-body">
                        {!! Form::open(['method'=>'POST','route'=>'user.mobappuserstore','class'=>'form-horizontal']) !!}
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                            <div>{!! Form::label('username','Username:',['class'=>'col-md-4 control-label']) !!}</div>
                            <div class="col-md-4">{!! Form::text('username',null,['class'=>'form-control']) !!}</div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('role_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-2">{!! Form::select('role_id',[""=>"Assign Role","1"=>"Super Admin","2"=>"Food Admin","3"=>"Food Server","4"=>"Registration Assistant"],null,['class'=>'form-control']) !!}</div>
                        </div>
