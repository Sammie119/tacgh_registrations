...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>{{$camp_venue->name}} - Residences</h1>
            {{--<ol class="breadcrumb">--}}
                {{--<li><a href="#"><i class="fa fa-dashboard"></i>{{$camp_venue->name}}</a></li>--}}
                ...
                <div class="col-md-12">
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            <h3 class="box-title">Setup Residence</h3>
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form action="{{route('residence.set_gender',[$camp_venue->slug])}}" method="post">
                                <input type="hidden" name="venue" value="{{$camp_venue->slug}}">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <select type="text" name="residence" id="residence" required class="form-control">
                                            ...
                                            @foreach($camp_venue->residences as $res)
                        ...
                        <div class="box-header">
                            <div class="row" style="margin-bottom: 10px">
                                ...
                                <div class="col-md-4 text-right">
                                    <a href="{{ route('create_residence',[$camp_venue->slug]) }}" class="btn bg-orange btn-flat margin">Add Residence</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <table id="residences" class="table table-bordered table-striped table-hover">
                                    ...
                                    @foreach($camp_venue->residences as $res)
                                        ...
                                        <tr>
                                            <td>{{ $count++ }}</td>
                                            <td>{{ $res->name }}</td>
                                            <td>{{ $res->blocks->count()." out of ".$res->total_blocks }}</td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('edit_residence',[$camp_venue->slug,$res->id]) }}" class="btn btn-success btn-flat">
                                                    <i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>
                                                <a href="{{ route('residence.blocks',[$camp_venue->slug,$res->id]) }}" class="btn btn-primary btn-flat">
                                                    <i class="fa fa-th-large" aria-hidden="true"></i> Setup Blocks</a>
                                            </td>
                                        </tr>
