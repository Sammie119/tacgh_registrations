            ...
            <div class="row">
                <div class="box box-solid">
                    ...
                    <div class="panel-body">
                        {!! Form::model($campfee,['method'=>'PATCH','route'=>['campfee.update',$campfee],'class'=>'form-horizontal']) !!}
{{--                        {!! Form::open(['method'=>'POST','url'=>'campfee','class'=>'form-horizontal']) !!}--}}
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label" style="margin:10px">
                                <input type="checkbox"  name="active_flag" class="flat-red" id="active_flag" value="1"
                                        {{ ($campfee->active_flag == '1') ? 'checked' : '' }}/>
                                Active Record?
                            </label>
                        </div>
